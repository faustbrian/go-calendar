...
That structural interface is satisfied by `go-clock.Clock` without importing
...
Pass those endpoints to `go-temporal/instant.Range`; interval relations and set
algebra remain owned by go-temporal.
